...
private:
	...
	void loadConsts(std::string filename); // load resources from the json file
	...
	sdl_resource_table<double> consts_; // consts map (string -> double)
	...
	map_access_wrapper<double> constsAccessWrapper_;
